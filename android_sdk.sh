...
sdk_packages=(
    ...
    'Android SDK Platform-Tools -- 28.0.2 -- platform-tools'
    ...
    'Android SDK Build-Tools -- 29.0.0 rc1 -- build-tools;29.0.0-rc1'
    'GPU Debugging tools -- 3.1.0 -- extras;android;gapid;3'
    'Android Emulator -- 28.0.25 -- emulator'
    'Documentation for Android SDK -- 1 -- docs'
    'Google Play APK Expansion library -- 1 -- extras;google;market_apk_expansion'
    'Google Play Instant Development SDK -- 1.7.0 -- extras;google;instantapps'
